...
{
    public partial class ReqHrVolcanoContext : IdentityDbContext<IdentityUser, IdentityRole, string>
    {
        public ReqHrVolcanoContext()
        {
        }

        public ReqHrVolcanoContext(DbContextOptions<ReqHrVolcanoContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Emp>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.Emps)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK_Emp_AspNetUsers");
            });
